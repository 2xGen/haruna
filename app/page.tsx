            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-stretch">
              ...
              <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-white/10 flex flex-col h-full">
                ...
                <div className="mt-auto pt-6">
                  <Link href="/over-ons" className="inline-flex items-center justify-center gap-2 py-4 px-7 border-2 border-nbg-green text-nbg-green rounded-xl font-semibold text-[17px] hover:bg-nbg-green hover:text-white transition-all w-full sm:w-auto">
              ...
              <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-[0_4px_20px_rgba(0,0,0,0.08)] border border-white/10 flex flex-col h-full">
                ...
                <div className="mt-auto pt-6 flex flex-col gap-3">
                  <Link
                    href="/hypotheken/hypotheek-berekenen"
                    className="group inline-flex items-center justify-center gap-2.5 py-4 px-7 bg-white text-nbg-green rounded-xl font-semibold text-[17px] border-2 border-nbg-green/20 shadow-[0_4px_14px_rgba(0,0,0,0.08)] hover:bg-nbg-lighter-green/40 hover:border-nbg-green/40 hover:-translate-y-0.5 transition-all duration-200"
                  >
