  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-nbg-lighter-green pt-12 lg:pt-20 pb-14 lg:pb-20">
          <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-10 lg:gap-14 items-start">
              <div>
                <p className="text-nbg-primary font-semibold text-sm uppercase tracking-wider mb-3">Verzekeringen</p>
                <h1 className="text-nbg-blue text-3xl sm:text-4xl lg:text-5xl xl:text-[3rem] font-bold tracking-tight max-w-2xl">
                  Verzekeringen – zekerheid die bij u past
                </h1>
                <p className="mt-5 text-nbg-blue/80 text-[17px] lg:text-lg leading-relaxed max-w-xl">
                  Zakelijk, voor uw hypotheek of particulier: wij helpen u met de juiste verzekeringen. Online advies, helder en zonder gedoe.
                </p>
                ...
                <p className="mt-8 text-nbg-blue/70 text-sm">
                  ...
                  {" · "}
                  <Link href="#hypotheek" className="text-nbg-green font-medium hover:underline">Voor uw hypotheek</Link>
                  {" · "}
                  <Link href="#particulier" className="text-nbg-green font-medium hover:underline">Particulier</Link>
                  {" · "}
                  <Link href="#schade" className="text-nbg-green font-medium hover:underline">Schade melden</Link>
                </p>
              </div>
              <div className="p-6 sm:p-7 rounded-2xl bg-white border border-nbg-light-gray/60 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
                ...
                <ul className="space-y-1.5 mb-5 text-nbg-blue/85 text-sm">
                  <li className="flex items-center gap-2">
                    ...
                    Zakelijk – uw bedrijf beschermd
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0" aria-hidden />
                    Particulier – woonhuis, auto, reizen
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0" aria-hidden />
                    Voor uw hypotheek – passende zekerheid
                  </li>
                </ul>
                <Link
                  href="/contact"
        ...
        {/* Zakelijk */}
        <section id="zakelijk" className="py-14 lg:py-20 bg-white scroll-mt-20">
          <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
              <div className="lg:col-span-7">
                <div className="border-l-4 border-nbg-green pl-5 mb-6">
                  <h2 className="text-nbg-blue text-2xl lg:text-3xl font-bold m-0">Zakelijk</h2>
                </div>
                <p className="text-nbg-blue/85 text-[17px] leading-relaxed mb-6">
                  Als ondernemer wilt u uw bedrijf goed beschermen. Wij kijken samen met u welke risico&apos;s er spelen en welke verzekeringen daarbij passen. Denk aan:
                </p>
                <ul className="space-y-2 text-nbg-blue/85 text-[17px]">
                  <li className="flex items-start gap-2">
                    ...
                    Brand, diefstal en overval
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0 mt-2" aria-hidden />
                    Schade aan pand of inventaris
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0 mt-2" aria-hidden />
                    Juridische zaken
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0 mt-2" aria-hidden />
                    Ziekte van uzelf of personeel
                  </li>
                </ul>
                <p className="mt-6 text-nbg-blue/85 text-[17px] leading-relaxed">
                  Ook voor voorzieningen rond ziekte, ongeval of uw pensioen als ondernemer helpen we u graag. Heeft u vragen? Neem gerust contact op.
                </p>
              </div>
        ...
        {/* Voor uw hypotheek */}
        <section id="hypotheek" className="py-14 lg:py-20 bg-nbg-lighter-green scroll-mt-20">
          <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
              <div className="lg:col-span-7">
                <div className="border-l-4 border-nbg-green pl-5 mb-6">
                  <h2 className="text-nbg-blue text-2xl lg:text-3xl font-bold m-0">Voor uw hypotheek</h2>
                </div>
                <p className="text-nbg-blue/85 text-[17px] leading-relaxed mb-6">
                  Een hypotheek is persoonlijk. Daarom kijken we niet alleen naar de rente, maar ook naar uw situatie: gezin, eigen middelen, zekerheden en plannen. Zo krijgt u advies dat echt bij u past.
                </p>
                <p className="text-nbg-blue/85 text-[17px] leading-relaxed mb-6">
                  Huis kopen of hypotheek oversluiten? Wij leggen de mogelijkheden uit en denken mee over spaar- en risicoverzekeringen, hypotheekrisicoverzekering, uitvaartverzekering en meer. Ook zakelijke schadeverzekeringen regelen we voor u.
                </p>
                <ul className="flex flex-wrap gap-2 mb-6">
                  {["Spaarverzekeringen", "Risicoverzekeringen", "Hypotheekrisicoverzekering", "Uitvaartverzekering", "Studieverzekeringen"].map((item) => (
                    <li key={item}>
                      <span className="inline-block py-2 px-4 rounded-full bg-white/80 text-nbg-blue text-[15px] font-medium border border-nbg-light-gray/50">
                        {item}
                      </span>
                    </li>
                  ))}
        ...
        <section id="particulier" className="py-14 lg:py-20 bg-white scroll-mt-20">
          <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
              <div className="lg:col-span-7">
                <div className="border-l-4 border-nbg-green pl-5 mb-6">
                  <h2 className="text-nbg-blue text-2xl lg:text-3xl font-bold m-0">Particulier</h2>
                </div>
                <p className="text-nbg-blue/85 text-[17px] leading-relaxed mb-6">
                  Voor uw huis en dagelijks leven: wij helpen u met verzekeringen die u echt nodig heeft. Bijvoorbeeld:
                </p>
                <ul className="space-y-2 text-nbg-blue/85 text-[17px] mb-6">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0 mt-2" aria-hidden />
                  ...
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-nbg-green shrink-0 mt-2" aria-hidden />
                    Auto, rechtsbijstand, ongevallen en reizen
                  </li>
                </ul>
        ...
        {/* Handige gidsen over verzekeringen */}
        <section className="bg-nbg-lighter-green py-12 lg:py-16">
          <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-between items-end gap-4 mb-8">
              <h2 className="text-nbg-blue text-2xl font-bold m-0">Handige gidsen over verzekeringen</h2>
        ...
        {/* Schade melden */}
        <section id="schade" className="py-14 lg:py-20 bg-nbg-blue scroll-mt-20">
          <div className="max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
              <div className="lg:col-span-7">
                <div className="border-l-4 border-nbg-green pl-5 mb-6">
                  <h2 className="text-white text-2xl lg:text-3xl font-bold m-0">Schade melden</h2>
                </div>
                <p className="text-white/90 text-[17px] leading-relaxed mb-4">
                  Heeft u schade? Meld het ons zo snel mogelijk. Mail ons met uw polisnummer en een korte omschrijving van de schade. We verwerken uw melding en nemen contact met u op. Binnen drie werkdagen ontvangt u een bevestiging met een schadenummer, waarmee u de voortgang kunt volgen.
                </p>
                <p className="text-white/80 text-[15px] m-0">
                  Stuur een e-mail naar{" "}
                  <a href="mailto:schade@haruna.nl" className="text-nbg-green font-medium hover:underline">schade@haruna.nl</a>.
                </p>
              </div>
              <div className="lg:col-span-5">
                <div className="bg-white rounded-2xl p-6 lg:p-8 border border-white/20 shadow-[0_4px_20px_rgba(0,0,0,0.15)]">
                  <h3 className="text-nbg-blue font-bold text-lg m-0 mb-2">Schade melden</h3>
                  <p className="text-nbg-blue/80 text-[15px] m-0 mb-4">
                    Mail ons met uw polisnummer en de informatie over de schade. We nemen zo snel mogelijk contact op.
                  </p>
                  <a
                    href="mailto:schade@haruna.nl"
